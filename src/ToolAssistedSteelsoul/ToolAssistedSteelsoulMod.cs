...
namespace ToolAssistedSteelsoul
{
    ...
    /// </summary>
    public class ToolAssistedSteelsoulMod : Mod, ITogglableMod, IGlobalSettings<GlobalSettings>, ICustomMenuMod
    {
        internal static ToolAssistedSteelsoulMod Instance { get; private set; }
        ...
        public ToolAssistedSteelsoulMod() : base("Tool Assisted Steelsoul")
        {
        }
        ...
        public override void Initialize()
        {
            ...
            // Title-screen shortcut into the save manager. Purely additive: if the injection
            // fails it logs and the vanilla menu is left as it was.
